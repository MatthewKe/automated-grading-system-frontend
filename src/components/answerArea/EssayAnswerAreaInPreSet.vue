...
function startDrag(event) {
  event.dataTransfer.setData("text/plain", "new a essayAnswerArea")
}
...
onMounted(() => {
  const canvas = document
      .getElementById('essayAnswerAreaInPreSet')
  ...
  ctx.fillText('作文题', canvas.width / 2, canvas.height / 2)
})
